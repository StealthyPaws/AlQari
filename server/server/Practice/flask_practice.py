...
DB_PATH = r"C:\Users\User\Downloads\FYP\Practice\makharij_practice.db"
...
def practice():
    ...
    if not gt:
        return jsonify({"error": "gt phoneme missing"}), 400

    temp_path = "temp_input.wav"
    file.save(temp_path)

    result = evaluate_attempt(temp_path, gt)

    audio_path = f"C:\\Users\\User\\Downloads\\FYP\\Practice\\remarks\\{result['category']}.wav"
